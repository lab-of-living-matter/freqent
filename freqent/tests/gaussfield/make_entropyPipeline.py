...
ax[0, 0].set(ylabel=r'$\omega$', title=r'$Re [C_{00}]$', ylim=[-50, 50])
...
ax_smooth[0, 0].set(ylabel=r'$\omega$', title=r'$Re [C_{00}]$', ylim=[-50, 50])
...
# ax_smooth_inv_diff[0, 0].pcolorfast(freqs[1], freqs[0], c_smooth_inv_diff[..., 0, 0].real, rasterized=True)
# ax_smooth_inv_diff[0, 0].set(ylabel=r'$\omega$', title=r'$ \log (Re [C_{00}])$')

# ax_smooth_inv_diff[0, 1].pcolorfast(freqs[1], freqs[0], c_smooth_inv_diff[..., 0, 1].real, rasterized=True)
# ax_smooth_inv_diff[0, 1].set(title=r'$Re [C_{01}]$')

# ax_smooth_inv_diff[1, 0].pcolorfast(freqs[1], freqs[0], c_smooth_inv_diff[..., 0, 0].imag, cmap='RdBu_r', rasterized=True)
# ax_smooth_inv_diff[1, 0].set(xlabel=r'$k$', ylabel=r'$\omega$', title=r'$Im [C_{00}]$')

# ax_smooth_inv_diff[1, 1].pcolorfast(freqs[1], freqs[0], c_smooth_inv_diff[..., 0, 1].imag, cmap='RdBu_r', rasterized=True)
...
ax_sdensity[0, 0].pcolorfast(freqs[1], freqs[0], sdensity_matrix[..., 0, 0].real, rasterized=True)
ax_sdensity[0, 0].set(ylabel=r'$\omega$', title=r'$Re [C_{00}]$', ylim=[-50, 50])

ax_sdensity[0, 1].pcolorfast(freqs[1], freqs[0], sdensity_matrix[..., 0, 1].real, cmap='RdBu_r', rasterized=True)
ax_sdensity[0, 1].set(title=r'$Re [C_{01}]$', ylim=[-50, 50])

ax_sdensity[1, 0].pcolorfast(freqs[1], freqs[0], sdensity_matrix[..., 0, 0].imag, cmap='RdBu_r', rasterized=True)
ax_sdensity[1, 0].set(xlabel=r'$k$', ylabel=r'$\omega$', title=r'$Im [C_{00}]$', ylim=[-50, 50])

ax_sdensity[1, 1].pcolorfast(freqs[1], freqs[0], sdensity_matrix[..., 0, 1].imag, cmap='RdBu_r', rasterized=True)
